...
APPNAME=mtb-example-btsdk-mesh-sensorhub
...
# Add additional defines to the build process.
CY_APP_DEFINES+=-DENABLE_DEBUG=0
CY_APP_DEFINES+=-DLOW_POWER_NODE=0
